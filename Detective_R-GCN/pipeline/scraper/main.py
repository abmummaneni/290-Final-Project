...
# This file lives at pipeline/scraper/main.py — go up two dirs to reach Detective_R-GCN/.
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
sys.path.insert(0, PROJECT_ROOT)

from pipeline.scraper.loader import load_candidates
from pipeline.scraper.wikipedia import scrape_synopsis
from pipeline.scraper.cleaner import clean_synopsis
from pipeline.scraper.validator import score_synopsis

# Paths relative to the Detective_R-GCN project root
XLSX_PATH = os.path.join(PROJECT_ROOT, "data", "candidates.xlsx")
DATA_DIR = os.path.join(PROJECT_ROOT, "data")
RAW_DIR = os.path.join(DATA_DIR, "synopses_raw")
CLEANED_DIR = os.path.join(DATA_DIR, "synopses")
