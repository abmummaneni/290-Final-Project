"""
Phase 2 main: extract structured graph data from scraped synopses.
"""
...
# Project root: Detective_R-GCN/  (this file lives at pipeline/extraction/main.py)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(_LOG_DIR, "extraction.log")),
        logging.StreamHandler(),
    ],
)
logger = logging.getLogger(__name__)

MANIFEST_PATH = os.path.join(_PROJECT_ROOT, "data", "manifest.json")
CLEANED_DIR = os.path.join(_PROJECT_ROOT, "data", "synopses")
GRAPHS_DIR = os.path.join(_PROJECT_ROOT, "data", "graphs")
EXTRACTION_STATUS_PATH = os.path.join(_PROJECT_ROOT, "data", "extraction_status.json")
