...
def _parse_json_response(text, entry_id, pass_name):
    ...
    try:
        ...
        try:
            ...
            # Debug dump path: data/debug/ at project root
            _project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
            debug_dir = os.path.join(_project_root, "data", "debug")
...
def save_graph(graph, entry_id, output_dir=None):
    """Save extracted graph JSON to file. Default output_dir is data/graphs at the project root."""
    if output_dir is None:
        _project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        output_dir = os.path.join(_project_root, "data", "graphs")
