"""
Re-extract graphs for stories with detailed synopses.

Reads synopses from data/synopses_detailed/{ID}.txt, extracts graphs via
Ollama (mixtral:8x7b), and writes them to data/graphs/{ID}.json, overwriting
...
NEW_EXTRACTS_DIR = os.path.join(_PROJECT_ROOT, "data", "synopses_detailed")
