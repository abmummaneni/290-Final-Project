...
Input:  data/graphs/{ID}.json         (576 heterogeneous graphs)
Output: data/graphs_simple/{ID}.json  (576 simple graphs)

Run:
    cd /Users/maxdesantis/dev/290-Final-Project/Detective_R-GCN
    python -m pipeline.extraction_simple.build_simple_graphs
"""
...
# Project root: Detective_R-GCN/  (this file lives at pipeline/extraction_simple/build_simple_graphs.py)
_PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
HETERO_DIR = os.path.join(_PROJECT_ROOT, "data", "graphs")
SIMPLE_DIR = os.path.join(_PROJECT_ROOT, "data", "graphs_simple")
