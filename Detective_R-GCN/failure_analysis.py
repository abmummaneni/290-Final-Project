...
from load_mystery_graphs import load_mystery_graphs, CHARACTER_FEATURES
...
def main():
    ...
    parser.add_argument("--graph_dir", default="extraction/data/graphs")
    parser.add_argument("--out", default="failure_analysis_results.txt")
